        ...
        <form action="/tasks" method="POST">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 25px;">
                ...
                <div>
                    ...
                    <input type="text" id="category" name="category" placeholder="e.g., Work, Personal" required style="width: 100%; background: #fff; color: #333; padding: 12px; border: 2px solid #000000; border-radius: 8px; font-size: 14px; transition: all 0.3s ease;" onfocus="this.style.borderColor='#17a2b8'" onblur="this.style.borderColor='#000000'">
                </div>
            </div>
            ...
            <!-- Submit Button -->
            <button type="submit" class="btn btn-add" style="width: 100%; padding: 14px; font-size: 16px; font-weight: 600; border: none; cursor: pointer;">✓ Create Task</button>
        </form>
    </div>
</div>