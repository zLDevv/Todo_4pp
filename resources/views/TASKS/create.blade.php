...
<div class="container">
    ...
    <div class="dashboard-header">
        <div class="header-content">
            <h1>Create Task</h1>
            <p>Add a new task to get things done</p>
        </div>
    ...
    <div class="card" style="padding: 32px; max-width: 600px;">
        <form action="/tasks" method="POST" style="gap: 24px;">
            ...
            <div>
                ...
                <input type="text" id="title" name="title" value="{{ old('title') }}" placeholder="What do you need to accomplish?" required style="width: 100%;">
            ...
            <div>
                ...
                <textarea id="description" name="description" placeholder="Add details about your task...">{{ old('description') }}</textarea>
