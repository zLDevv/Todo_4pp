        ...
        <div class="card" style="margin-bottom: 18px;">
            ...
            <div style="display: flex; gap: 8px; flex-wrap: wrap; justify-content: space-between; align-items: center;">
                <div style="display: flex; gap: 8px; flex-wrap: wrap;">
                    <form action="/tasks/{{ $task->id }}/favorite" method="POST" style="display: inline;">
                        @csrf
                        <button class="btn" style="background: {{ $task->favorite ? '#fbbf24' : '#6b7280' }}; padding: 8px 12px; font-size: 12px; border: none; cursor: pointer;">{{ $task->favorite ? '⭐ Favorited' : '☆ Favorite' }}</button>
                    </form>
                ...
                <div style="display: flex; gap: 8px;">
                    ...
                    <form action="/tasks/{{ $task->id }}" method="POST" style="display: inline;">
                        @csrf
                        @method('DELETE')
                        <button type="button" class="btn btn-delete" onclick="openModal(this)">🗑️ Delete</button>
                    </form>
                </div>
            </div>
        </div>
